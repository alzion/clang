/* this is my implementation of the printf function. I have divided everything into smaller functions for readability.*/
...
char * my_itoa(int num, char *str, int base);     // i put the names of the functions here so the first actual function would be main. 
int my_strlen(const char* a);                      // however, i have deleted "main" before submission
